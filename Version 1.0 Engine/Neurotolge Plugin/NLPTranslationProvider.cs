...
{
    class NLPTranslationProvider : ITranslationProvider
    {
        public static readonly string NLPTranslationProviderScheme = "nlpprovider";

        #region "NLPTranslationOptions"
        public NLPTranslationOptions Options
        {
            get;
            set;
        }
        ...
        {
            return new NLPTranslationProviderLanguageDirection(this, languageDirection);
        }
        ...
        {
            get { return NLPTranslationOptions.ProviderTranslationMethod; }
        }
