    ...
    class ListTranslationProviderLanguageDirection : ITranslationProviderLanguageDirection
    {
        ...
        private string searchInServer(String sourceString)
        {
            if (_neurotolgeConnector == null)
            {
                ...
                string Auth = _options.Auth;

                // Use features
                string domain = _options.selectedDomain;
                ...
                _neurotolgeConnector = new NeurotolgeConnector(URL, Auth, domain);
            }
        ...
        public SearchResults[] SearchTranslationUnitsMasked(SearchSettings settings, TranslationUnit[] translationUnits, bool[] mask)
        {
            ...
            if (_neurotolgeConnector == null)
            {
                var translator = new NeurotolgeConnector(URL, Auth, domain);
